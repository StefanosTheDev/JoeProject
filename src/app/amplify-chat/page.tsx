...
import Sidebar, { type Conversation } from "@/app/amplify-chat/components/Sidebar";
import ChatMessages from "@/app/amplify-chat/components/ChatMessages";
import ChatInput from "@/app/amplify-chat/components/ChatInput";
import WelcomeScreen from "@/app/amplify-chat/components/WelcomeScreen";
...
export default function AmplifyChat() {
  ...
  const transport = useMemo(() => new DefaultChatTransport({ api: "/amplify-chat/api/chat" }), []);
