...
const categories: Category[] = [
  ...
  },
  {
    ...
    order: 4,
    status: "in_progress",
    description: "The follow-up engine. Nurture, confirm, recover no-shows, and drip long-term value. Ready to plug into HighLevel.",
    progress: 30,
    sections: [
...
const statusConfig: Record<Status, StatusConfigEntry> = {
