...
import { MOCK_ICP } from "@/apps/amplify-os/lib/mock-data";
import IcpCard from "@/apps/amplify-os/components/phases/icp/IcpCard";
import IcpRefinement from "@/apps/amplify-os/components/phases/icp/IcpRefinement";
...
export default function IcpPage() {
  ...
  if (isGenerating) {
    return (
      <div>
        <h1 className="text-2xl font-semibold tracking-tight">ICP Discovery</h1>
